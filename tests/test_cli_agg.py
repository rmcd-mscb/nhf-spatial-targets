...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("snodas", "nhf_spatial_targets.cli.aggregate_snodas"),
        ("ua-swe", "nhf_spatial_targets.cli.aggregate_ua_swe"),
...
def test_agg_all_runs_every_source(tmp_path):
    ...
    target_fns = [
        ...
        "nhf_spatial_targets.cli.aggregate_snodas",
        "nhf_spatial_targets.cli.aggregate_ua_swe",
